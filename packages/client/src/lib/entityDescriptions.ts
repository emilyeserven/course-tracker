...
export const ENTITY_DESCRIPTIONS = {
  ...
  routines:
    "Repeatable practices you schedule and follow through on. Each routine runs on a weekly or daily cadence and can link to the tasks and resources it supports.",
  dailies:
